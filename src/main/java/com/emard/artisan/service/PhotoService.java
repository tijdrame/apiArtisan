...
import com.emard.artisan.repository.PhotoRepository;
...
public class PhotoService {
    ...
    public Page<Photo> findAll(Pageable pageable) {
        ...
        return photoRepository.findByDeletedFalseOrderByProduit_Libelle(pageable);
    }
    ...
    public void delete(Long id) {
        ...
        if(photo.isPresent()) photo.get().deleted(true);
