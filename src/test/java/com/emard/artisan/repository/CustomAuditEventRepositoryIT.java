...
import com.emard.artisan.config.audit.AuditEventConverter;
import com.emard.artisan.domain.PersistentAuditEvent;
...
import static com.emard.artisan.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
