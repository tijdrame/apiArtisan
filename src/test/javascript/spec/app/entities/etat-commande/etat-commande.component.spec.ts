...
import { EtatCommandeComponent } from 'app/entities/etat-commande/etat-commande.component';
...
describe('Component Tests', () => {
  describe('EtatCommande Management Component', () => {
    let comp: EtatCommandeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EtatCommandeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.etatCommandes && comp.etatCommandes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
