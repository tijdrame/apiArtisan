...
import { ArtisanComponent } from 'app/entities/artisan/artisan.component';
import { ArtisanService } from 'app/entities/artisan/artisan.service';
import { Artisan } from 'app/shared/model/artisan.model';

describe('Component Tests', () => {
  describe('Artisan Management Component', () => {
    let comp: ArtisanComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ArtisanComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.artisans && comp.artisans[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
